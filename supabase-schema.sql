...
VALUES ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 3533, 'Goal')
ON CONFLICT DO NOTHING;

INSERT INTO events (id, game_id, event_time_ms, label)
VALUES ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000010', 870, 'Headshot 1')
ON CONFLICT DO NOTHING;

INSERT INTO events (id, game_id, event_time_ms, label)
VALUES ('00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000010', 3740, 'Headshot 2')
ON CONFLICT DO NOTHING;

INSERT INTO events (id, game_id, event_time_ms, label)
VALUES ('00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000010', 7580, 'Headshot 3')
ON CONFLICT DO NOTHING;
